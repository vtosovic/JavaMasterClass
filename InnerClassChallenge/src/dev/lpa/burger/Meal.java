...
public class Meal {
    ...
    public double getTotal(){
        // price cannot be called directly, but using a getter.
        // Burger is not subclass here, but of Meal
    ...
    private class Burger extends Item {
        ...
        // this is implicitly static, and cannot be used before Java 16 in an inner class
        // ; at the end is used when adding extra code
        ...
        private void addToppings(String... selectedToppings){
            for (String selectedTopping : selectedToppings){
                try {
                    ...
                    System.out.println("No topping for " + selectedTopping);
                }
            }
        }
        @Override
