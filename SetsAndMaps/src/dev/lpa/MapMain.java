...
public class MapMain {
    public static void main(String[] args) {
        ...
        // no phone number! If the key exists, the value is replaced, so phones were replaced
        ...
        // adding default for empty, it will be not added in the map
...
//        }
        ...
        // to put only if it does not exist (PUT IF ABSENT):
        System.out.println("-------------------------------");
        contacts.clear();
        for(Contact contact:fullList){
        ...
        //key=Daffy Duck, value= Daffy Duck: [daffy@google.com] []
        // it will ignore an element if there is something in the map
        //key=Mickey Mouse, value= Mickey Mouse: [] [(999) 888-7777]


        // PUT IF ABSENT with MERGE
        System.out.println("-------------------------------");
        contacts.clear();
        for(Contact contact:fullList){
...
//                    return merged;
        ...
        contacts.forEach((k,v) -> System.out.println("key=" + k + ", value= " + v));
        //prev: Mickey Mouse: [] [(999) 888-7777] : current Mickey Mouse: [] [(124) 748-9758]
        //merged: Mickey Mouse: [] [(124) 748-9758, (999) 888-7777]
        //prev: Robin Hood: [] [(564) 789-3000] : current Robin Hood: [] [(789) 902-8222]
        //merged: Robin Hood: [] [(789) 902-8222, (564) 789-3000]
        //prev: Mickey Mouse: [] [(124) 748-9758, (999) 888-7777] : current Mickey Mouse: [] [(999) 888-7777]
        //merged: Mickey Mouse: [] [(124) 748-9758, (999) 888-7777]
        //prev: Mickey Mouse: [] [(124) 748-9758, (999) 888-7777] : current Mickey Mouse: [mckmouse@gmail.com] []
        //merged: Mickey Mouse: [mckmouse@gmail.com] [(124) 748-9758, (999) 888-7777]
        //prev: Mickey Mouse: [mckmouse@gmail.com] [(124) 748-9758, (999) 888-7777] : current Mickey Mouse: [micky1@aws.com] []
        //merged: Mickey Mouse: [micky1@aws.com, mckmouse@gmail.com] [(124) 748-9758, (999) 888-7777]
        //prev: Minnie Mouse: [] [(456) 780-5666] : current Minnie Mouse: [minnie@verizon.net] []
        //merged: Minnie Mouse: [minnie@verizon.net] [(456) 780-5666]
        //prev: Robin Hood: [] [(789) 902-8222, (564) 789-3000] : current Robin Hood: [rhood@gmail.com] []
        ...
        // USING NORMAL COMPUTE, not computeIfAbsent
        ...
        // if used replacedContact
        //Did not match on both key: Daisy Duck and value: Daisy Duck: [DaisyDuck@funplace.com] []
        // if used daisy
        ...
        // REMOVE
        System.out.println("--------------------------");
        success = contacts.remove("Dausy Duck", daisy);
        if (success){
            System.out.println("Successfully replaced element");
        } else {
            System.out.printf("Did not match on both key: %s and value: %s %n"
